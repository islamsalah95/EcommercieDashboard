...
## in terminal path you must run those commands below

1- clone EcommercieDashboard/edit/main/README.md
2- composer install
3-npm install
4-php artisan serve
4-npm run watch
import the sql database file in import folder make sure the same name in env
